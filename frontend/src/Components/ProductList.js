      ...
      <div>
        ...
        >
          <div>
            ...
            >
              <Link to="/addProduct" style={{color:"white", textDecoration:"none" }}>Add New</Link>
            </button>
          </div>
          {/* Table */}
          <div
                  ...
                  <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                      {productList.map((product) => (
                        <tr key={product._id} style={{backgroundColor: "#F2F2F2"}}>
                        <td style={{fontFamily:"Poppins", fontStyle:"normal",fontWeight:"400",fontSize:"16px",lineHeight:"24px",color:"#000000"}} >
                          ...
                          {product.status?(<td style={{fontFamily:"Poppins", fontStyle:"normal",fontWeight:"400",fontSize:"16px",lineHeight:"24px", color:"#2DA323"}}>
                            Active
